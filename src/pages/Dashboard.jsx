...
const LocationLink = ({ location }) => {
    ...
    return (
        <a
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-600 rounded-full text-[11px] font-black uppercase tracking-tight hover:bg-blue-100 transition-all border border-blue-100 shadow-sm group max-w-full whitespace-nowrap overflow-hidden"
            title={cityName}
        >
                            ...
                            <div className="lg:col-span-7 premium-card flex flex-col h-full overflow-hidden">
                                ...
                                <div className="flex flex-col flex-1">
                                    <div className="flex items-center px-4 py-3 bg-[#f8fafc] text-slate-500 font-bold uppercase tracking-wider text-[10px] border-b border-slate-50">
                                        ...
                                        <div className="w-32 shrink-0 flex-none text-right pr-2">Location</div>
                                    </div>
                                        ...
                                        {loading ? (
                                            [1, 2, 3].map(i => (
                                                <div key={i} className="flex items-center px-4 py-4">
                                                    ...
                                                    <div className="w-32 pr-2"><Skeleton className="h-6 w-20 ml-auto" /></div>
                                                </div>
                                            ))
                                            ...
                                            recentActivity.filter(r => r.status === 'PRESENT').map((record) => (
                                                <div key={record.id} className="flex items-center px-4 py-3 hover:bg-slate-50/50 transition-colors border-b border-slate-50 last:border-0">
                                                    ...
                                                    <div className="w-32 shrink-0 flex-none text-right pr-2 flex items-center justify-end overflow-hidden">
